...
//      digitalWrite(RELAY, HIGH);
      ...
      String httpRequestData = "api_key=" + apiKeyValue + "&TEGANGANPANEL=" + String(0.4)
                               + "&ARUSPANEL=" + String(arusSolar) + "&TEGANGANCADANGAN=" + String(0.3)
                               + "&ARUSCADANGAN=" + String(arusCadangan) + "&TEGANGANBEBAN=" + String(234)
                               + "&ARUSBEBAN=" + String(0.6) + "&CAHAYA=" + String(light_level) + "";
